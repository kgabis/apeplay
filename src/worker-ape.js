...
define("ace/mode/ape_worker",[], function(require, exports, module) {
    "use strict";
    ...
    var ApeWorker = exports.ApeWorker = function(sender) {
        Mirror.call(this, sender);
        this.setTimeout(500);
        this.setOptions();
    };
    
    oop.inherits(ApeWorker, Mirror);
